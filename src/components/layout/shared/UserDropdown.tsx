  ...
  return (
    <>
      ...
      >
        <Avatar
          ref={anchorRef}
          alt={auth?.user?.userData?.Name}
          src={auth?.user?.userData?.ProfilePicture || '/images/avatars/1.png'}
                  ...
                  <div className='flex items-center plb-2 pli-4 gap-2' tabIndex={-1}>
                    ...
                    <div className='flex items-start flex-col'>
                      ...
                      <Typography variant='caption' className='lowercase'>
                        {auth?.user?.userData?.Email}
                      </Typography>
                    </div>
                  </div>
                  <Divider className='mlb-1' />
                  <MenuItem className='gap-3 pli-4' onClick={e => handleDropdownClose(e, routes.profile)}>
