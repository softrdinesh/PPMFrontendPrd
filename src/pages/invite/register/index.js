...
import { registerWithInvitationApi } from '@api/project'
...
const RegisterOnInvite = () => {
  ...
  const onSubmit = async formData => {
    ...
    if (register?.status) {
      ...
      localStorage.setItem(authConfig.storageLoginUserData, JSON.stringify(register.data))
...
RegisterOnInvite.getLayout = page => <BlankLayout>{page}</BlankLayout>
RegisterOnInvite.authGuard = false
